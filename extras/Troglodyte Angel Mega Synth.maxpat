...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 708.0, 450.0, 176.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 792.0, 321.0, 17.0, 129.0 ]
				}
...
, 			{
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-5::obj-10" : [ "live.numbox[6]", "live.numbox[1]", 0 ],
			...
			"obj-5::obj-81" : [ "live.numbox[4]", "live.numbox[1]", 0 ],
